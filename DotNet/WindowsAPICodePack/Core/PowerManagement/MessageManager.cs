...
namespace Microsoft.WindowsAPICodePack.ApplicationServices
{
    ...
    public static class MessageManager
    {
        ...
        /// messages.
        /// </summary>
        public class PowerRegWindow : Form
        {
            private Hashtable eventList = new Hashtable();
            private ReaderWriterLock readerWriterLock = new ReaderWriterLock();

            public PowerRegWindow()
                : base()
            {
            ...
            public void RegisterPowerEvent(Guid eventId, EventHandler eventToRegister)
            {
            ...
            public void UnregisterPowerEvent(Guid eventId, EventHandler eventToUnregister)
            {
                readerWriterLock.AcquireWriterLock(Timeout.Infinite);
                if (eventList.Contains(eventId))
                {
