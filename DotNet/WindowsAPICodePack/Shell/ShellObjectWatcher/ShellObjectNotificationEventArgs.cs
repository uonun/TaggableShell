...
namespace Microsoft.WindowsAPICodePack.Shell
{
    ...
    public class ShellObjectNotificationEventArgs : EventArgs
    {
        ...
        public ShellObjectNotificationEventArgs(ChangeNotifyLock notifyLock)
        {
    ...
    public class ShellObjectChangedEventArgs : ShellObjectNotificationEventArgs
    {
        ...
        public ShellObjectChangedEventArgs(ChangeNotifyLock notifyLock)
            : base(notifyLock)
        {
    ...
    public class ShellObjectRenamedEventArgs : ShellObjectChangedEventArgs
    {
        ...
        public ShellObjectRenamedEventArgs(ChangeNotifyLock notifyLock)
            : base(notifyLock)
        {
    ...
    public class SystemImageUpdatedEventArgs : ShellObjectNotificationEventArgs
    {
        ...
        public SystemImageUpdatedEventArgs(ChangeNotifyLock notifyLock)
            : base(notifyLock)
        {
