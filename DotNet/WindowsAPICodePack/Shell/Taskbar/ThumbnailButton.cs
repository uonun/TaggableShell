...
namespace Microsoft.WindowsAPICodePack.Taskbar
{
    ...
    public sealed class ThumbnailToolBarButton : IDisposable
    {
        ...
        // if any of our properties change or if it's just an public update
        ...
        {
            // Start public update (so we don't accidently update the taskbar
            // via the native API)
            internalUpdate = true;
        ...
        /// </summary>
        public ThumbButtonOptions Flags { get; set; }

        /// <summary>
        /// Native representation of the thumbnail button
        /// </summary>
        public ThumbButton Win32ThumbButton
        {
            get
            {
        ...
        public void FireClick(TaskbarWindow taskbarWindow)
        {
