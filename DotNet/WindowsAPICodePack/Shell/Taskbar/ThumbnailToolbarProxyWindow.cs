...
{
    public class ThumbnailToolbarProxyWindow : NativeWindow, IDisposable
    {
        private ThumbnailToolBarButton[] _thumbnailButtons;
        private IntPtr _internalWindowHandle;

        public System.Windows.UIElement WindowsControl { get; set; }
        ...
        public TaskbarWindow TaskbarWindow { get; set; }
        ...
        public ThumbnailToolbarProxyWindow(System.Windows.UIElement windowsControl, ThumbnailToolBarButton[] buttons)
        {
