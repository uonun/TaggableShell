...
namespace Microsoft.WindowsAPICodePack.Dialogs
{
    ...
    {
        // Make the default constructor public so users can't instantiate this 
        // collection by themselves.
        public CommonFileDialogFilterCollection() { }

        public ShellNativeMethods.FilterSpec[] GetAllFilterSpecs()
        {
