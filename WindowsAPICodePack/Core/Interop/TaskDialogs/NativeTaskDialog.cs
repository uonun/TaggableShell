...
namespace Microsoft.WindowsAPICodePack.Dialogs
{
    ...
    /// </remarks>
    public class NativeTaskDialog : IDisposable
    {
        ...
        public NativeTaskDialog(NativeTaskDialogSettings settings, TaskDialog outerDialog)
        {
        ...
        private int PerformDialogInitialization()
        {
            ...
            else if (IsOptionSet(TaskDialogNativeMethods.TaskDialogOptions.ShowMarqueeProgressBar))
            {
                ...
                // Note that this public task dialog setting is 
        ...
        public void UpdateProgressBarRange()
        {
            AssertCurrentlyShowing();
        ...
        public void UpdateProgressBarState(TaskDialogProgressBarState state)
        {
            AssertCurrentlyShowing();
        ...
        public void UpdateExpandedText(string expandedText)
        {
        ...
        public void UpdateMainIcon(TaskDialogStandardIcon mainIcon)
        {
            UpdateIconCore(mainIcon, TaskDialogNativeMethods.TaskDialogIconElement.Main);
        }

        public void UpdateFooterIcon(TaskDialogStandardIcon footerIcon)
        {
        ...
        public void UpdateCheckBoxChecked(bool cbc)
        {
            AssertCurrentlyShowing();
            SendMessageHelper(
        ...
        public void UpdateElevationIcon(int buttonId, bool showIcon)
        {
            AssertCurrentlyShowing();
            SendMessageHelper(
        ...
        public void UpdateButtonEnabled(int buttonID, bool enabled)
        {
            AssertCurrentlyShowing();
            SendMessageHelper(
        ...
        public void UpdateRadioButtonEnabled(int buttonID, bool enabled)
        {
            AssertCurrentlyShowing();
        ...
        public void AssertCurrentlyShowing()
        {
