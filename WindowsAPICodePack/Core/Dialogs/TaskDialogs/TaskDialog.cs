...
namespace Microsoft.WindowsAPICodePack.Dialogs
{
    ...
    public sealed class TaskDialog : IDialogControlHost, IDisposable
    {
        ...
        // or use it directly - it is only for the public 
        ...
        // are triggered.
        public void RaiseButtonClickEvent(int id)
        {
        ...
        public void RaiseHyperlinkClickEvent(string link)
        {
        ...
        public int RaiseClosingEvent(int id)
        {
        ...
        public void RaiseHelpInvokedEvent()
        {
        ...
        public void RaiseTickEvent(int ticks)
        {
