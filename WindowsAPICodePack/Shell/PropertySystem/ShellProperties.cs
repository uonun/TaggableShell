...
namespace Microsoft.WindowsAPICodePack.Shell.PropertySystem
{
    ...
    public partial class ShellProperties : IDisposable
    {
        ...
        public ShellProperties(ShellObject parent)
        {
        ...
        public IShellProperty CreateTypedProperty<T>(PropertyKey propKey)
        {
        ...
        public IShellProperty CreateTypedProperty(string canonicalName)
        {
