...
{
    public static class TaskbarWindowManager
    {
        public static List<TaskbarWindow> _taskbarWindowList = new List<TaskbarWindow>();

        private static bool _buttonsAdded;

        public static void AddThumbnailButtons(IntPtr userWindowHandle, params ThumbnailToolBarButton[] buttons)
        {
        ...
        public static void AddThumbnailButtons(System.Windows.UIElement control, params ThumbnailToolBarButton[] buttons)
        {
        ...
        public static void AddTabbedThumbnail(TabbedThumbnail preview)
        {
        ...
        public static TaskbarWindow GetTaskbarWindow(System.Windows.UIElement windowsControl, TaskbarProxyWindowType taskbarProxyWindowType)
        {
        ...
        public static TaskbarWindow GetTaskbarWindow(IntPtr userWindowHandle, TaskbarProxyWindowType taskbarProxyWindowType)
        {
        ...
        private static bool DispatchNCDestroyMessage(ref System.Windows.Forms.Message m, TaskbarWindow taskbarWindow)
        {
            if (m.Msg == (int)WindowMessage.NCDestroy)
            {
                ...
                // Remove the taskbar window from our public list
        ...
        public static bool DispatchMessage(ref System.Windows.Forms.Message m, TaskbarWindow taskbarWindow)
        {
        ...
        public static void SetActiveTab(TaskbarWindow taskbarWindow)
        {
            if (taskbarWindow != null)
            {
        ...
        public static void UnregisterTab(TaskbarWindow taskbarWindow)
        {
            if (taskbarWindow != null)
            {
                TaskbarList.Instance.UnregisterTab(taskbarWindow.WindowToTellTaskbarAbout);
        ...
        public static void InvalidatePreview(TaskbarWindow taskbarWindow)
        {
            if (taskbarWindow != null)
            {
