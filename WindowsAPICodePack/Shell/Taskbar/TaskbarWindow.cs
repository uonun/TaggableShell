...
namespace Microsoft.WindowsAPICodePack.Taskbar
{
    ...
    {
        public TabbedThumbnailProxyWindow TabbedThumbnailProxyWindow { get; set; }

        public ThumbnailToolbarProxyWindow ThumbnailToolbarProxyWindow { get; set; }

        public bool EnableTabbedThumbnails { get; set; }

        public bool EnableThumbnailToolbars { get; set; }

        public IntPtr UserWindowHandle { get; set; }

        public UIElement WindowsControl { get; set; }
        ...
        public IntPtr WindowToTellTaskbarAbout
        {
            get
            {
        ...
        public TaskbarWindow(IntPtr userWindowHandle, params ThumbnailToolBarButton[] buttons)
        {
        ...
        public TaskbarWindow(System.Windows.UIElement windowsControl, params ThumbnailToolBarButton[] buttons)
        {
