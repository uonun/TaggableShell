...
{
    public sealed class TabbedThumbnailProxyWindow : Form, IDisposable
    {
        
        public TabbedThumbnailProxyWindow(TabbedThumbnail preview)
        {
        ...
        public TabbedThumbnail TabbedThumbnail { get; private set; }

        public UIElement WindowsControl { get; private set; }

        public IntPtr WindowToTellTaskbarAbout { get { return this.Handle; } }
