...
namespace Microsoft.WindowsAPICodePack.Taskbar
{
    ...
    public class TabbedThumbnail : IDisposable
    {
        ...
        public Window WindowsControlParentWindow { get; set; }
        ...
        public bool RemovedFromTaskbar { get; set; }
        ...
        public IntPtr CurrentHBitmap { get; set; }
        ...
        public void OnTabbedThumbnailMaximized()
        {
        ...
        public void OnTabbedThumbnailMinimized()
        {
        ...
        public bool OnTabbedThumbnailClosed()
        {
            ...
            // Remove it from the public list as well as the taskbar
            TaskbarManager.Instance.TabbedThumbnail.RemoveThumbnailPreview(this);
            return true;
        }

        public void OnTabbedThumbnailActivated()
        {
