...
namespace Microsoft.WindowsAPICodePack.Dialogs
{
    ...
    public abstract class CommonFileDialog : IDialogControlHost, IDisposable
    {
        ...
        public readonly Collection<IShellItem> items;
        public DialogShowState showState = DialogShowState.PreShow;
        ...
        public abstract void InitializeNativeFileDialog();
        public abstract IFileDialog GetNativeFileDialog();
        public abstract void PopulateWithFileNames(Collection<string> names);
        public abstract void PopulateWithIShellItems(Collection<IShellItem> shellItems);
        public abstract void CleanUpNativeFileDialog();
        public abstract ShellNativeMethods.FileOpenOptions GetDerivedOptionFlags(ShellNativeMethods.FileOpenOptions flags);
