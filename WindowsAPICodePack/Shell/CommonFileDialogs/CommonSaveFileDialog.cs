...
namespace Microsoft.WindowsAPICodePack.Dialogs
{
    ...
    public sealed class CommonSaveFileDialog : CommonFileDialog
    {
        ...
        public override IFileDialog GetNativeFileDialog()
        {
        ...
        public override void PopulateWithFileNames(
        ...
        public override void PopulateWithIShellItems(System.Collections.ObjectModel.Collection<IShellItem> items)
        {
            IShellItem item;
            saveDialogCoClass.GetResult(out item);
        ...
        public override void CleanUpNativeFileDialog()
        {
            if (saveDialogCoClass != null)
            {
        ...
        public override ShellNativeMethods.FileOpenOptions GetDerivedOptionFlags(ShellNativeMethods.FileOpenOptions flags)
        {
            if (overwritePrompt)
            {
