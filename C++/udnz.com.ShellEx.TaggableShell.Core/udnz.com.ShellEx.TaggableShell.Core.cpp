// udnz.com.ShellEx.TaggableShell.Core.cpp : 定义 DLL 应用程序的导出函数。
//
...
// 这是已导出类的构造函数。
// 有关类定义的信息，请参阅 udnz.com.ShellEx.TaggableShell.Core.h
CudnzcomShellExTaggableShellCore::CudnzcomShellExTaggableShellCore()
{
	return;
}
